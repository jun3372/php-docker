<?php
/* http://www.Docker-PHP.net */
/* webmaster@Docker-PHP.net */
$version = '18.07.9SF';
...
<title>Docker-PHP PHP探针安全版</title>
<meta name="keywords" content="php探针,Docker-PHP探针,PHP探针安全版,php7探针,phpinfo,php扩展,数据库连接测试" />
<meta name="description" content="Docker-PHP php探针安全版兼容最新php7,需成功测试连接本地数据库后才显示phpinfo动态链接页面和网站路径,更安全的php探针." />
<meta name="author" content="Docker-PHP" />
<meta name="reply-to" content="webmaster@Docker-PHP.net" />
<meta name="copyright" content="Docker-PHP Team" />
<style type="text/css">
<!--
...
<body>
<div class="head1"><a href="http://www.Docker-PHP.net/tanzhen/n126.html" style="color:#ffffff" >{ Docker-PHP PHP 探针 }</a></div>
<div class="head2"></div>
...
<?php
        ...
        echo "<a href='#data'><span style='color:green'>数据库连接测试成功后显示</span></a>";
    }
?>
</td>
...
<?php
if ($link) {
        $str1 = '<span style="color: #008000; font-weight: bold;">连接正常 </span> ('.mysqli_get_server_info($link).')';
    } else {
        $str1 = '<span style="color: #ff0000; font-weight: bold;">连接错误</span><br />'.mysqli_connect_error();
    } ?>
<tr>
...
<?php $up_time = sprintf('%0.6f', micro_time_float() - $up_start); ?>Docker-PHP探针版本:<?php echo $version; ?>&nbsp;&nbsp;&nbsp;页面执行时间 <?php echo $up_time; ?> 秒&nbsp;&nbsp;&nbsp;消耗内存 <?php echo memory_usage(); ?>
</p>
<hr style="width:100%; color:#cdcdcd" noshade="noshade" size="1" />
<p style="color:#505050; font-size:14px; text-align:center;">&copy; <?php echo date('Y'); ?> <a href="https://www.zhexue.fun" target="_blank">Docker-PHP PHP探针安全版</a>，站点内容与本程序无关。</p>
</div>
</body>
</html>
